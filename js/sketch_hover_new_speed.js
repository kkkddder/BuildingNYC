...
function setup(){
  ...
  for (var p=0; p<lot_bbl.length; p++){
    ...
    changeOwnership(OwnershipTable);
    noLoop();
}
...
function mousePressed() {
  ...
  if (mouseX <= 839 && mouseX >= 720 && mouseY >= 3395 && mouseY <= 3944) {
        ...
        sortby();
        changeOwnership(LotValueTable);
      } else if (mouseX < 697 && mouseX >= 578 && mouseY >= 3395 && mouseY <= 3944) {
        ...
        sortby();
        changeOwnership(LotAreaTable);
      } else if (mouseX < 554 && mouseX >= 435 && mouseY >= 3395 && mouseY <= 3944) {
...
function mouseMoved(){
  ...
  if (mouseX < 360 && mouseX >= 120 && mouseY >= 3370 && mouseY <= 3440) {
        ...
        cursor_change();
      } else if (mouseX <= 839 && mouseX >= 720 && mouseY >= 3395 && mouseY <= 3944) {
        cursor_change();
      } else if (mouseX < 697 && mouseX >= 578 && mouseY >= 3395 && mouseY <= 3944) {
        cursor_change();
      } else if (mouseX < 554 && mouseX >= 435 && mouseY >= 3395 && mouseY <= 3944) {
  ...
  if (mouseX>435 && mouseX<840 && mouseY > 20 && mouseY < 3340){
        // loop();
        // redraw();

        var number=int((mouseY-topMar)/(lineHeight+1));
        ...
        // stroke(197, 42, 95,20);
        noFill();
        stroke(color(197, 42, 95));
        rect(435, number*(lineHeight+1) + topMar, 405, lineHeight);
        stroke(0,0,17);
        ...
        if (number<44){
          ...
          rect(right_margin1 + 20, topMar, 360, 3540);
...
function changeOwnership(Table) {
...
function narrative(){
  ...
  print(endNarr+50+paragraph+inbox_space+15+575);
...
function draw(){
  ...
  backgroundcolor = color(0,0,17);
  backgroundcolorLight = color(0,0,30,10);
